...
def render_3d_avatar_preview(avatar_key: str):
    ...
    _mod = (
        ...
        # body - blue jacket with breathing
        '<g transform="translate(110,155)">'
        '<animateTransform attributeName="transform" type="scale" values="1,1; 1.01,1.015; 1,1" dur="2.5s" repeatCount="indefinite" additive="sum"/>'
        '<rect x="-34" y="-37" width="68" height="74" rx="9" fill="url(#bg2)"/>'
        '</g>'
        # lapels
        ...
        '<animateTransform attributeName="transform" type="rotate" values="6; 10; 6" dur="3s" repeatCount="indefinite" additive="sum"/>'
        '<rect x="-9" y="0" width="18" height="52" rx="7" fill="url(#bg2)"/>'
        '<ellipse cx="0" cy="56" rx="9" ry="9" fill="url(#sg)"/>'
        '</g>'
        # right arm raised with wave animation
        '<g transform="translate(157,120)">'
        '<animateTransform attributeName="transform" type="rotate" values="-55; -35; -55" dur="2s" repeatCount="indefinite" additive="sum"/>'
        '<rect x="-9" y="0" width="18" height="52" rx="7" fill="url(#bg2)"/>'
        '<ellipse cx="0" cy="56" rx="9" ry="9" fill="url(#sg)"/>'
        '</g>'
        # neck
        ...
        # head group with sway animation
        '<g transform="translate(110,72)">'
        '<animateTransform attributeName="transform" type="rotate" values="0; 1.5; 0; -1; 0" dur="4s" repeatCount="indefinite" additive="sum"/>'
        '<animateTransform attributeName="transform" type="translate" values="0,0; 0.5,0; 0,0; -0.5,0; 0,0" dur="4s" repeatCount="indefinite" additive="sum"/>'
        # head
        ...
        # cheeks
        '<ellipse cx="-18" cy="8" rx="9" ry="6" fill="#ff7777" opacity="0.22"/>'
        '<ellipse cx="18" cy="8" rx="9" ry="6" fill="#ff7777" opacity="0.22"/>'
        # eyes with blinking
        ...
        '</g>'
        # headset arc
        '<path d="M82 62 Q110 38 138 62" stroke="#222222" stroke-width="5" fill="none" stroke-linecap="round"/>'
        # earpads
        ...
        '<path d="M146 66 Q153 74 152 84" stroke="#333333" stroke-width="3" fill="none" stroke-linecap="round"/>'
        # mic ball (red)
    ...
    _pon = (
        ...
        '<g transform="translate(63,120)">'
        '<animateTransform attributeName="transform" type="rotate" values="38; 48; 38" dur="2.5s" repeatCount="indefinite" additive="sum"/>'
        '<rect x="-9" y="0" width="18" height="52" rx="7" fill="url(#bg2)"/>'
        '<ellipse cx="0" cy="56" rx="9" ry="9" fill="url(#sg)"/>'
        ...
        # right arm - thumbs up
        '<g transform="translate(157,120)">'
        '<animateTransform attributeName="transform" type="rotate" values="-70; -55; -70" dur="2.2s" repeatCount="indefinite" additive="sum"/>'
        '<rect x="-9" y="0" width="18" height="52" rx="7" fill="url(#bg2)"/>'
        ...
        '<animateTransform attributeName="transform" type="translate" values="0,0; 0.5,0; 0,0; -0.5,0; 0,0" dur="4s" repeatCount="indefinite" additive="sum"/>'
        '<ellipse cx="0" cy="0" rx="33" ry="36" fill="url(#sg)"/>'
        '<ellipse cx="0" cy="-26" rx="33" ry="17" fill="#5c3010"/>'
        '<rect x="-33" y="-25" width="66" height="14" fill="#5c3010"/>'
        '<ellipse cx="0" cy="-16" rx="30" ry="8" fill="#7a4420"/>'
        '<ellipse cx="-18" cy="8" rx="9" ry="6" fill="#ff7777" opacity="0.22"/>'
        '<ellipse cx="18" cy="8" rx="9" ry="6" fill="#ff7777" opacity="0.22"/>'
        '<g transform="translate(-11, -4)">'
        '<ellipse cx="0" cy="0" rx="7.5" ry="7.5" fill="white"/>'
        ...
        '</ellipse>'
        '</g>'
        '<path d="M-17 -15 Q-11 -18 -5 -15" stroke="#5c3010" stroke-width="2.5" fill="none" stroke-linecap="round"/>'
        '<path d="M5 -15 Q11 -18 17 -15" stroke="#5c3010" stroke-width="2.5" fill="none" stroke-linecap="round"/>'
        '<ellipse cx="0" cy="5" rx="3" ry="2" fill="#cc7755"/>'
        '<path d="M-9 11 Q0 21 9 11" stroke="#cc5533" stroke-width="2" fill="none" stroke-linecap="round"/>'
        '</g>'
        ...
        '<circle cx="0" cy="0" r="14" fill="#007722" opacity="0.9"/>'
        '<circle cx="0" cy="0" r="12" fill="#00cc44"/>'
        '<path d="M-7 0 L-1 7 L8 -8" stroke="white" stroke-width="3" fill="none" stroke-linecap="round" stroke-linejoin="round"/>'
        '</g>'
        '</g>'
    )
    ...
    _apr = (
        ...
        '</g>'
        '<g transform="translate(157,120)">'
        '<animateTransform attributeName="transform" type="rotate" values="-50; -42; -50" dur="2.5s" repeatCount="indefinite" additive="sum"/>'
        '<rect x="-9" y="0" width="18" height="52" rx="7" fill="url(#bg2)"/>'
        '<ellipse cx="0" cy="56" rx="9" ry="9" fill="url(#sg)"/>'
    ...
    _sil = (
        ...
        '<rect x="-34" y="-37" width="68" height="74" rx="9" fill="url(#bg2)"/>'
        '</g>'
        # left arm raised with animation
        '<g transform="translate(63,120)">'
        '<animateTransform attributeName="transform" type="rotate" values="-55; -40; -55" dur="2s" repeatCount="indefinite" additive="sum"/>'
        '<rect x="-9" y="0" width="18" height="52" rx="7" fill="url(#bg2)"/>'
        '<ellipse cx="0" cy="56" rx="9" ry="9" fill="url(#sg)"/>'
        '</g>'
        # right arm raised with animation
        '<g transform="translate(157,120)">'
        '<animateTransform attributeName="transform" type="rotate" values="-55; -70; -55" dur="2.2s" repeatCount="indefinite" additive="sum"/>'
        '<rect x="-9" y="0" width="18" height="52" rx="7" fill="url(#bg2)"/>'
        '<ellipse cx="0" cy="56" rx="9" ry="9" fill="url(#sg)"/>'
        '</g>'
        '<rect x="104" y="105" width="12" height="16" rx="4" fill="url(#sg)"/>'
        ...
        '<ellipse cx="0" cy="-26" rx="33" ry="17" fill="#3a2008"/>'
        '<rect x="-33" y="-25" width="66" height="14" fill="#3a2008"/>'
        '<path d="M-22 -25 Q-18 -34 -13 -27" stroke="#3a2008" stroke-width="6"'
        ' fill="none" stroke-linecap="round"/>'
        '<path d="M5 -28 Q10 -37 16 -29" stroke="#3a2008" stroke-width="6"'
        ' fill="none" stroke-linecap="round"/>'
        '<ellipse cx="-18" cy="8" rx="9" ry="6" fill="#ff7777" opacity="0.22"/>'
        '<ellipse cx="18" cy="8" rx="9" ry="6" fill="#ff7777" opacity="0.22"/>'
        # eyes with blinking
        ...
        '<path d="M-17 -11 Q-11 -15 -5 -12" stroke="#3a2008" stroke-width="2.8"'
        ' fill="none" stroke-linecap="round"/>'
        '<path d="M5 -12 Q11 -15 17 -11" stroke="#3a2008" stroke-width="2.8"'
        ' fill="none" stroke-linecap="round"/>'
        '<ellipse cx="0" cy="5" rx="3" ry="2" fill="#cc7755"/>'
        # open frustrated mouth
        '<path d="M-6 14 Q0 8 6 14" stroke="#cc5533" stroke-width="2"'
        ' fill="none" stroke-linecap="round"/>'
        '<ellipse cx="0" cy="16" rx="6" ry="4" fill="#cc5533" opacity="0.4"/>'
        '</g>'
        ...
        '<rect x="0" y="0" width="18" height="28" rx="9" fill="#888888"/>'
        '<ellipse cx="9" cy="0" rx="9" ry="9" fill="#aaaaaa"/>'
        '<path d="M2 34 Q9 42 16 34" stroke="#888888" stroke-width="2.5"'
        ' fill="none" stroke-linecap="round"/>'
        '<line x1="9" y1="28" x2="9" y2="34" stroke="#888888" stroke-width="2.5"'
        ' stroke-linecap="round"/>'
        # red slash over mic
        '<line x1="-4" y1="-5" x2="22" y2="38" stroke="#ff2200" stroke-width="3"'
        ' stroke-linecap="round"/>'
        '</g>'
        '</g>'
    )
    ...
    _sec = (
        ...
        '<rect x="-34" y="-37" width="68" height="74" rx="9" fill="url(#bg2)"/>'
        '</g>'
        # left arm holding notepad with idle sway
        '<g transform="translate(63,120)">'
        '<animateTransform attributeName="transform" type="rotate" values="28; 34; 28" dur="2.5s" repeatCount="indefinite" additive="sum"/>'
        '<rect x="-9" y="0" width="18" height="52" rx="7" fill="url(#bg2)"/>'
        '<ellipse cx="0" cy="56" rx="9" ry="9" fill="url(#sg)"/>'
        # notepad
        ...
        '</g>'
        # right arm writing with back-and-forth motion
        '<g transform="translate(157,120)">'
        '<animateTransform attributeName="transform" type="rotate" values="-30; -20; -30" dur="1.2s" repeatCount="indefinite" additive="sum"/>'
        '<rect x="-9" y="0" width="18" height="52" rx="7" fill="url(#bg2)"/>'
        '<ellipse cx="0" cy="56" rx="9" ry="9" fill="url(#sg)"/>'
        # pen in hand
        ...
        '<ellipse cx="0" cy="0" rx="33" ry="36" fill="url(#sg)"/>'
        # tidy medium hair
        '<ellipse cx="0" cy="-26" rx="33" ry="17" fill="#4a2808"/>'
        '<rect x="-33" y="-25" width="66" height="14" fill="#4a2808"/>'
        '<path d="M-33 -22 Q0 -34 33 -22" stroke="#5a3010" stroke-width="3" fill="none"/>'
        '<ellipse cx="-18" cy="8" rx="9" ry="6" fill="#ff7777" opacity="0.22"/>'
        '<ellipse cx="18" cy="8" rx="9" ry="6" fill="#ff7777" opacity="0.22"/>'
        # eyes with blinking
        '<g transform="translate(-11, -4)">'
        ...
        '<path d="M-17 -13 Q-11 -15 -5 -13" stroke="#4a2808" stroke-width="2.5"'
        ' fill="none" stroke-linecap="round"/>'
        '<path d="M5 -13 Q11 -15 17 -13" stroke="#4a2808" stroke-width="2.5"'
        ' fill="none" stroke-linecap="round"/>'
        '<ellipse cx="0" cy="5" rx="3" ry="2" fill="#cc7755"/>'
        # focused slight smile
        '<path d="M-6 13 Q0 17 6 13" stroke="#cc5533" stroke-width="2"'
        ' fill="none" stroke-linecap="round"/>'
        '</g>'
        '</g>'
    )
    ...
    _tec = (
        ...
        '<rect x="82" y="244" width="28" height="13" rx="5" fill="#111122"/>'
        '<rect x="108" y="244" width="28" height="13" rx="5" fill="#111122"/>'
        # gray hoodie body with breathing
        '<g transform="translate(110,155)">'
        '<animateTransform attributeName="transform" type="scale" values="1,1; 1.01,1.015; 1,1" dur="2.5s" repeatCount="indefinite" additive="sum"/>'
        '<rect x="-34" y="-37" width="68" height="74" rx="9" fill="url(#bg2)"/>'
        # hoodie front pocket
        '<rect x="-20" y="0" width="40" height="26" rx="6" fill="#3a3a4a"/>'
        # hoodie drawstring
        '<line x1="-8" y1="-37" x2="-12" y2="-15" stroke="#333344" stroke-width="2"'
        ' stroke-linecap="round"/>'
        '<line x1="8" y1="-37" x2="12" y2="-15" stroke="#333344" stroke-width="2"'
        ' stroke-linecap="round"/>'
        '</g>'
        ...
        '<ellipse cx="0" cy="56" rx="9" ry="9" fill="url(#sg)"/>'
        '</g>'
        # right arm raised with wrench (scratching head)
        '<g transform="translate(157,120)">'
        '<animateTransform attributeName="transform" type="rotate" values="-65; -50; -65" dur="2.2s" repeatCount="indefinite" additive="sum"/>'
        '<rect x="-9" y="0" width="18" height="52" rx="7" fill="url(#bg2)"/>'
        '<ellipse cx="0" cy="56" rx="9" ry="9" fill="url(#sg)"/>'
        # wrench in hand
        ...
        '<ellipse cx="0" cy="-24" rx="32" ry="14" fill="#4a4a5a"/>'
        '<rect x="-32" y="-24" width="64" height="14" fill="#4a4a5a"/>'
        '<path d="M-32 -20 Q-34 -2 -33 26" stroke="#5a5a6a" stroke-width="9"'
        ' fill="none" stroke-linecap="round"/>'
        '<path d="M32 -20 Q34 -2 33 26" stroke="#5a5a6a" stroke-width="9"'
        ' fill="none" stroke-linecap="round"/>'
        # small dark hair visible below hood
        '<ellipse cx="0" cy="-18" rx="24" ry="8" fill="#3a2808"/>'
        '<ellipse cx="-18" cy="8" rx="9" ry="6" fill="#ff7777" opacity="0.22"/>'
        '<ellipse cx="18" cy="8" rx="9" ry="6" fill="#ff7777" opacity="0.22"/>'
        # eyes with blinking
        '<g transform="translate(-11, -4)">'
        ...
        '<path d="M-17 -14 Q-11 -19 -5 -15" stroke="#3a2808" stroke-width="2.8"'
        ' fill="none" stroke-linecap="round"/>'
        '<path d="M5 -13 Q11 -15 17 -13" stroke="#3a2808" stroke-width="2.5"'
        ' fill="none" stroke-linecap="round"/>'
        # round glasses
        '<circle cx="-11" cy="-3" r="11" fill="none" stroke="#222222" stroke-width="2.5"/>'
        '<circle cx="11" cy="-3" r="11" fill="none" stroke="#222222" stroke-width="2.5"/>'
        '<line x1="0" y1="-3" x2="2" y2="-3" stroke="#222222" stroke-width="2"/>'
        # glass lens tint
        '<circle cx="-11" cy="-3" r="10" fill="#aaddff" opacity="0.15"/>'
        '<circle cx="11" cy="-3" r="10" fill="#aaddff" opacity="0.15"/>'
        '<ellipse cx="0" cy="6" rx="3" ry="2" fill="#cc7755"/>'
        # confused half-smile
        '<path d="M-6 14 Q-3 17 2 15 Q6 14 7 16" stroke="#cc5533" stroke-width="2"'
        ' fill="none" stroke-linecap="round"/>'
        ...
        '<path d="M-13 -41 Q0 -53 13 -41" stroke="#00aaff" stroke-width="2.5"'
        ' fill="none" stroke-linecap="round" opacity="0.5"/>'
        '<path d="M-8 -35 Q0 -44 8 -35" stroke="#00ccff" stroke-width="2.5"'
        ' fill="none" stroke-linecap="round" opacity="0.7"/>'
        '<path d="M-4 -29 Q0 -34 4 -29" stroke="#44ddff" stroke-width="2.5"'
        ' fill="none" stroke-linecap="round"/>'
        '<circle cx="0" cy="-25" r="3" fill="#00aaff"/>'
        '</g>'
        '</g>'
        '</g>'
    )
    ...
    _exe = (
        ...
        '<rect x="82" y="244" width="28" height="13" rx="5" fill="#111122"/>'
        '<rect x="108" y="244" width="28" height="13" rx="5" fill="#111122"/>'
        # dark suit jacket with breathing
        '<g transform="translate(110,155)">'
        '<animateTransform attributeName="transform" type="scale" values="1,1; 1.01,1.015; 1,1" dur="2.5s" repeatCount="indefinite" additive="sum"/>'
        '<rect x="-34" y="-37" width="68" height="74" rx="9" fill="url(#bg2)"/>'
        # lapels (suit)
        '<polygon points="0,-37 -13,-9 -2,-16 0,-27" fill="#111122" opacity="0.95"/>'
        '<polygon points="0,-37 13,-9 2,-16 0,-27" fill="#111122" opacity="0.95"/>'
        # white shirt
        '<rect x="-5" y="-37" width="10" height="22" rx="3" fill="white" opacity="0.9"/>'
        # red tie
        '<polygon points="-3,-33 3,-33 5,-7 0,-1 -5,-7" fill="#cc1122"/>'
        '<polygon points="-2,-33 2,-33 0,-28" fill="#880011"/>'
        '</g>'
        # left arm idle
        '<g transform="translate(63,120)">'
        '<animateTransform attributeName="transform" type="rotate" values="6; 10; 6" dur="3s" repeatCount="indefinite" additive="sum"/>'
        ...
        '<ellipse cx="0" cy="-27" rx="33" ry="15" fill="#111111"/>'
        '<rect x="-33" y="-26" width="66" height="14" fill="#111111"/>'
        '<path d="M-33 -22 Q-10 -32 33 -22" stroke="#222222" stroke-width="3" fill="none"/>'
        '<path d="M-28 -17 Q0 -28 28 -17" stroke="#333333" stroke-width="2" fill="none"/>'
        '<ellipse cx="-18" cy="8" rx="9" ry="6" fill="#ff7777" opacity="0.22"/>'
        '<ellipse cx="18" cy="8" rx="9" ry="6" fill="#ff7777" opacity="0.22"/>'
        # eyes with blinking
        '<g transform="translate(-11, -4)">'
        ...
        '<path d="M-17 -13 Q-11 -15 -5 -13" stroke="#111111" stroke-width="2.5"'
        ' fill="none" stroke-linecap="round"/>'
        '<path d="M5 -15 Q11 -17 17 -14" stroke="#111111" stroke-width="2.5"'
        ' fill="none" stroke-linecap="round"/>'
        '<ellipse cx="0" cy="5" rx="3" ry="2" fill="#cc7755"/>'
        # smug slight smirk (asymmetric)
        '<path d="M-6 13 Q-1 17 6 12" stroke="#cc5533" stroke-width="2"'
        ' fill="none" stroke-linecap="round"/>'
        '</g>'
        '</g>'
    )
    ...
    _rem = (
        ...
        '<rect x="82" y="244" width="28" height="13" rx="5" fill="#111122"/>'
        '<rect x="108" y="244" width="28" height="13" rx="5" fill="#111122"/>'
        # purple hoodie body with breathing
        '<g transform="translate(110,155)">'
        '<animateTransform attributeName="transform" type="scale" values="1,1; 1.01,1.015; 1,1" dur="2.5s" repeatCount="indefinite" additive="sum"/>'
        '<rect x="-34" y="-37" width="68" height="74" rx="9" fill="url(#bg2)"/>'
        # hoodie front pocket
        '<rect x="-22" y="3" width="44" height="26" rx="7" fill="#2a0a5a"/>'
        # hoodie drawstrings
        '<line x1="-6" y1="-37" x2="-9" y2="-12" stroke="#2a0a5a" stroke-width="2.5"'
        ' stroke-linecap="round"/>'
        '<line x1="6" y1="-37" x2="9" y2="-12" stroke="#2a0a5a" stroke-width="2.5"'
        ' stroke-linecap="round"/>'
        '</g>'
        ...
        '<g transform="translate(63,120)">'
        '<animateTransform attributeName="transform" type="rotate" values="28; 32; 28" dur="2.5s" repeatCount="indefinite" additive="sum"/>'
        '<rect x="-9" y="0" width="18" height="52" rx="7" fill="url(#bg2)"/>'
        '<ellipse cx="0" cy="56" rx="9" ry="9" fill="url(#sg)"/>'
        # orange coffee mug
        ...
        ' fill="none" stroke-linecap="round"/>'
        # steam lines with SMIL animation
        '<g>'
        '<animateTransform attributeName="transform" type="translate" values="0,0; 0,-8; 0,-16" dur="1.5s" repeatCount="indefinite"/>'
        ...
        '<ellipse cx="0" cy="0" rx="33" ry="36" fill="url(#sg)"/>'
        # purple hoodie hood
        '<ellipse cx="0" cy="-24" rx="32" ry="14" fill="#3a1a6a"/>'
        '<rect x="-32" y="-24" width="64" height="14" fill="#3a1a6a"/>'
        '<path d="M-32 -20 Q-34 -2 -33 28" stroke="#4a2a7a" stroke-width="9"'
        ' fill="none" stroke-linecap="round"/>'
        '<path d="M32 -20 Q34 -2 33 28" stroke="#4a2a7a" stroke-width="9"'
        ' fill="none" stroke-linecap="round"/>'
        # dark hair under hood
        '<ellipse cx="0" cy="-18" rx="24" ry="8" fill="#2a1808"/>'
        '<ellipse cx="-18" cy="8" rx="9" ry="6" fill="#ff7777" opacity="0.22"/>'
        '<ellipse cx="18" cy="8" rx="9" ry="6" fill="#ff7777" opacity="0.22"/>'
        # eyes with blinking
        '<g transform="translate(-11, -4)">'
        ...
        '</g>'
        # relaxed brows
        '<path d="M-17 -13 Q-11 -15 -5 -13" stroke="#2a1808" stroke-width="2.5"'
        ' fill="none" stroke-linecap="round"/>'
        '<path d="M5 -13 Q11 -15 17 -13" stroke="#2a1808" stroke-width="2.5"'
        ' fill="none" stroke-linecap="round"/>'
        '<ellipse cx="0" cy="5" rx="3" ry="2" fill="#cc7755"/>'
        # relaxed smile
        '<path d="M-6 13 Q0 19 6 13" stroke="#cc5533" stroke-width="2"'
        ' fill="none" stroke-linecap="round"/>'
        # headphones
        '<path d="M-30 -10 Q0 -34 30 -10" stroke="#222233" stroke-width="6"'
        ' fill="none" stroke-linecap="round"/>'
        # headphone cups
        '<ellipse cx="-30" cy="-4" rx="11" ry="12" fill="#222233"/>'
        '<ellipse cx="30" cy="-4" rx="11" ry="12" fill="#222233"/>'
        '<ellipse cx="-30" cy="-4" rx="8" ry="9" fill="#4444bb"/>'
        '<ellipse cx="30" cy="-4" rx="8" ry="9" fill="#4444bb"/>'
        '</g>'
        '</g>'
    )
